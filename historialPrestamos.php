...
<!-- Listar Prestamos para profesor o usuario-->
...
try {
    ...
    if ($resultado) {
        ...
        registrarActividad($conexion, "visualizacion", "usuario " . $nombre . " visualizacion de historial prestamos");
