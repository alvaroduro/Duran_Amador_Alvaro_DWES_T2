...
<div class="row footer pt-4"> <!--Alineación fila-->
      <footer class="py-3"> <!--Padding vertical arriba y abajo-->
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
          <li class="nav-item">
            <a href="#" class="nav-link px-2 text-muted">Enlace sin contenido 3</a>
          </li>
          <li class="nav-item">
